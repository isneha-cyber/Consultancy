...
const Awaits = () => {
  ...
  return (
    <div>
      ...
      <div ref={sectionRef} className="relative bg-[#1d428c] overflow-hidden sm:min-h-screen">
        {/* Left decorative image with parallax - hidden on mobile */}
        <div 
        ...
        {/* Right decorative image with parallax - hidden on mobile */}
        <div 
        ...
        <div className="relative max-w-7xl mx-auto py-12 sm:py-16 md:py-24 px-4 sm:px-6 z-10 flex items-center min-h-screen">
          <div className="text-center space-y-4 sm:space-y-6 lg:space-y-8 w-full">
            {/* Main heading */}
            <h2 className='text-3xl sm:text-4xl lg:text-5xl md:max-w-xl md:mx-auto font-bold text-white px-2'>
              Your Dream Study{' '}
              <span className='relative inline-block mx-1 sm:mx-2'>
                ...
                <img 
                  className='absolute -bottom-2 sm:-bottom-3 lg:-bottom-5 left-0 w-full' 
            ...
            <div className="pt-2 sm:pt-4">
              <button className='inline-flex items-center justify-center bg-white text-[#1d428c] font-semibold text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-2.5 sm:py-3 rounded-full hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200'>
                Apply Now
              </button>
            </div>
          </div>
